...
var getStudentsHandler = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", res.status(_httpStatusCodes.BAD_REQUEST).send({
          ...
          case 4:
            ...
            return _context.abrupt("return", res.status(_httpStatusCodes.OK).send({
          ...
          case 10:
            ...
            return _context.abrupt("return", res.status(_httpStatusCodes.INTERNAL_SERVER_ERROR).send({
  ...
  return function getStudentsHandler(_x, _x2, _x3) {
